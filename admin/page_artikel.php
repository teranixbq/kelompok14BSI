                ...
                <tbody>
                    ...
                    foreach ($data as $row) :  ?>
                        <tr>
                            ...
                            <td><?= $row['kategori'] ?></td>
                            <td>
                                <a class="badge badge-success" href="artikel/artikel_edit.php?id_artikel=<?= $row['id_artikel'] ?>">Edit</a>
                                <a class="badge badge-danger" href="artikel/artikel_delete.php?id_artikel=<?= $row['id_artikel'] ?>" onclick="return confirm('Yakin ingin menghapus data ini?')">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach;
                    ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="artikel/artikel_add.php" method="POST" enctype="multipart/form-data">
