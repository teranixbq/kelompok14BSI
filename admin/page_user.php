                    ...
                    foreach ($data as $row) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="badge badge-success" href="user/user_edit.php?id_user=<?= $row['id_user'] ?>">Edit</a>
                                <a class="badge badge-danger" href="user/user_delete.php?id_user=<?= $row['id_user'] ?>" onclick="return confirm('Yakin ingin menghapus data ini?')">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
